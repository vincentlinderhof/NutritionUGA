...
myvars <- c("Foodexpenditure", "Nonfoodexpenditure", "Totalcroppedarea", "Householdsize", "DDS", "FCS",
            ...
            "Incomes","Numberofdifferentnonagriculturalincomesources", "Proportionoffoodconsumedinpreviousoneweekfromhouseholdsownproduction",
            "Simpsonsindex", "CaloriesperCapDay", "CaloriesbyHHmem", "CaloriesbyHH", "Agriculturalincomes")
...
## Check on consistency of Education houseold head
Pans2  <- Pans1
Pans2$HHID <- as.numeric(Pans2$HHID)
Pans2$Year <- as.numeric(Pans2$Year)
Edu2009 <- subset(Pans2, select = c("HHID", "Year", "Educationlevelofthehouseholdhead") )
Edu2009 <- subset(Edu2009, Year==1 ) 
Edu2010 <- subset(Pans2, select = c("HHID", "Year", "Educationlevelofthehouseholdhead") )
Edu2010 <- subset(Edu2010, Year==2 ) 
Edu2012 <- subset(Pans2, select = c("HHID", "Year", "Educationlevelofthehouseholdhead") )
Edu2012 <- subset(Edu2012, Year==3 ) 

Edu2009$EducationHead2009 <- Edu2009$Educationlevelofthehouseholdhead
Edu2009 <- subset(Edu2009, select = c("HHID", "EducationHead2009") )
Edu2010$EducationHead2010 <- Edu2010$Educationlevelofthehouseholdhead
Edu2010 <- subset(Edu2010, select = c("HHID", "EducationHead2010") )
Edu2012$EducationHead2012 <- Edu2012$Educationlevelofthehouseholdhead
Edu2012 <- subset(Edu2012, select = c("HHID", "EducationHead2012") )

Education <- dplyr::left_join(Edu2009, Edu2010)
Education <- left_join(Education, Edu2012)

frequencies(Education$EducationHead2009)
frequencies(Education$EducationHead2010)
frequencies(Education$EducationHead2012)

table(Education$EducationHead2009,Education$EducationHead2010)
table(Education$EducationHead2010,Education$EducationHead2012)
table(Education$EducationHead2009,Education$EducationHead2012)
